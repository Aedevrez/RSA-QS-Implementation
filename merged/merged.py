...
#MESSAGE = 6969696969 # This one causes a problem with key1
"""
    Test encryption/decryption:**************************************************
        Original message: 6969696969
        Encrypted: 166903588
        Decrypted: 539493799
        Match: NO
"""
...
def sieve_helper(n_values):
    ...
    for r in results:
        ...
        print(f"{r['key']:<8} {n_display:<18} {p_str:<10} {q_str:<10} {r['time']:.4f}")
